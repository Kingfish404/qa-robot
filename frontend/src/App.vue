...
export default {
  ...
  methods:{
    hiddeleftbar(){
      ...
      var el2 = document.getElementById("talkbody");
...
#headbutton:hover{
  ...
  height:4em;
  width:4em;
  box-shadow: 2px 0px 2px rgb(92, 87, 87);
  background-color: #3bac8f;
}
