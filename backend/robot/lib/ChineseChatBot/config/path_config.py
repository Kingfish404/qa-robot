...
BASE_CORPUS_PATH = join(abspath(dirname(__file__)),'../'+BASE_CORPUS_PATH)
...
BASE_CONFIG = join(abspath(dirname(__file__)),'')
...
BASE_INDEX_PATH = join(abspath(dirname(__file__)),'../'+BASE_INDEX_PATH)
