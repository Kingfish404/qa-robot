    ...
    <div id="robotbox" class="inner">
        <div id="dialogbox">
            <div id="content">
                ...
                <div id="content_main">
                    <div class="infinite-list" v-infinite-scroll="load" style="overflow:auto;max-width: 300px;">
                        <div v-for="QA in qa" v-bind:key="QA" class="infinite-list-item">
                           <div style="display:flex; padding:10px;float:left">
                               <div class="head"></div>
                               <div class="talk_content">{{QA.questions}}</div>
                           </div>
                           <div style="display:flex; padding:10px; float:right">
